  ...
  return (
    ...
    >
      ...
      <div className="hidden md:grid md:grid-cols-[44px_140px_1fr_110px_148px] md:items-center gap-0 px-5 py-4 pt-8">
        ...
        {/* Logo */}
        <div className="flex-shrink-0 h-18 flex items-center justify-center px-3 overflow-hidden">
          <img
      ...
      <div className="md:hidden px-4 py-3 pt-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-shrink-0 h-18 flex items-center justify-center px-2">
            <Image
              src={site.logo || "/placeholder.svg"}
              alt={`${site.name} logo`}
              width={140}
